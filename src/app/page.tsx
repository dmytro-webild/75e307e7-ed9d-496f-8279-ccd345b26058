...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      avatars={[
        {
          src: "http://img.b2bpic.net/free-photo/portrait-female-working_23-2148836087.jpg",
  ...
  <div id="about" data-section="about">
      ...
      description={[
        "CareTech is one of the leading names in North Kerala's IT service industry. We specialize in chip-level repairs, screen replacements, and comprehensive maintenance for Dell, Apple, HP, Lenovo, and more.",
        "Our mission is to exceed customer expectations through responsiveness, accountability, and technical expertise.",
      ]}
    />
  </div>
      ...
      features={[
        {
          ...
          imageSrc: "http://img.b2bpic.net/free-photo/portrait-female-working_23-2148836081.jpg",
        },
        {
          id: "f2",
          ...
          imageSrc: "http://img.b2bpic.net/free-photo/close-up-male-technician-holding-computer-motherboard_23-2147883860.jpg",
        },
        {
          id: "f3",
          ...
          imageSrc: "http://img.b2bpic.net/free-photo/man-suit-laptop_23-2147689150.jpg",
        },
      ]}
      ...
      metrics={[
        {
          ...
          description: "Laptops restored every month",
          icon: Wrench,
        },
        {
          id: "m2",
          ...
          description: "Expert service history",
          icon: Award,
        },
        {
          id: "m3",
  ...
  <div id="faq" data-section="faq">
      ...
      faqs={[
        {
          id: "q1",
          title: "Is there a testing fee?",
          content: "No, we look into your device for free and provide a non-obligatory quote.",
        },
        {
          id: "q2",
          title: "How long does repair take?",
          content: "Many repairs are completed on the same or next day, depending on part availability.",
        },
        {
          id: "q3",
          title: "Do you provide data recovery?",
          content: "Yes, cost depends on the damage. We offer free evaluation first.",
        },
      ]}
